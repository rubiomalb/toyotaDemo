CREATE DATABASE  IF NOT EXISTS `toyota` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `toyota`;
-- MySQL dump 10.13  Distrib 5.6.17, for osx10.6 (i386)
--
-- Host: 10.0.52.174    Database: toyota
-- ------------------------------------------------------
...
INSERT INTO `Car` VALUES (1,'Toyota Yaris 2015',14845.00),(2,'Toyota Corolla 2015',16900.00),(3,'Toyota Avalon',32560.00);
